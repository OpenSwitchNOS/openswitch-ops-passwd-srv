...
/* Following function is not used right now but may be used in future
 * if we decide to use admin/netop groups
static int
...
/* Function is not used right now but may be used in future if we decide
 * to keep the group names as admin/netop
