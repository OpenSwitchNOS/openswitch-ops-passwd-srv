...
- [Verify shared object installation](#check-lib.so)
...
2. Run 'ps aux | grep ops-passwd-srv'
...
### Objective
Ensure that socket descriptor is created for password server. The file is
under '/var/run/ops-passwd-srv/ops-passwd-srv.sock'
...
1. Open bash shell for OpenSwitch instance
2. Run 'ls -l /var/run/ops-passwd-srv/ops-passwd-srv.sock'
...
1. Open bash shell for OpenSwitch instance
2. Run 'ls -l /etc/ops-passwd-srv/ops-passwd-srv.yaml'
3. Make sure a file exists in the filesystem
...
## Check pub key file
### Objective
Ensure that public key is stored in the designated location. 
...
1. Open bash shell for OpenSwitch instance
2. Run 'ls -l /var/run/ops-passwd-srv/ops-passwd-srv-pub.pem'
3. Make sure a file exists in the filesystem
...
1. Open bash shell for OpenSwitch instance
2. Run 'ls -l /usr/lib/libpasswd_srv.so.0.1.0'
3. Make sure a file exists in the filesystem
